...
if($_SERVER['REQUEST_METHOD'] == 'GET')
{
	...
	/*
	mail("andrey_hz@outlook.com,maria@guiartemultimedia.com","asuntillo","Este es el cuerpo del mensaje"); */
...
<hr class="bg-primary">
<p>La información detallada así como la ficha de deposito será enviado al correo <b><?php echo $email; ?></b></b></p>
<hr>
