...
<body>
	<div class="row">     
		<div class="col-md-3  col-sm-12">
			...
			<div class="col-12 bg-light border border-success text-center">
				...
				<ul class="list-group">
					...
					<li class="list-group-item disabled"><a href="#" class="text-secondary disabled">Modificar contraseña</a></li>
		...
		<div class="col-md-8 col-sm-12 bg-light">
			<hr>
			<div class="container">
				<form method="POST" action="bd/cambiaPassword.php">
					<h2>Modificar Contraseña</h2>
					
					<p>
					<b class=" text-info">Constraseña actual <br></b> 
					<input type="text" class="form" name="apellidoPaterno" value=" <?php echo $atributo[0]['password']?>"></p>
					<p class=" text-info">Escriba la nueva contraseña</p>
					<input type="password" name="password">
					<p class=" text-info">Vuelva a repetir la contraseña</p>
