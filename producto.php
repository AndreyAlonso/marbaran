<?php
/**
* Ventana: producto.php
* Lista en una tabla los productos existentes en la base de datos
* 
*/
...
if(isset($_GET['busqueda'])){
  ...
  $id = $_GET['busqueda']; 
  // Consulta sql, se obtienen todos los productos que coincidan con el id del producto
  $sql2 = "SELECT * FROM producto WHERE nombre LIKE '%$id%'  ";
}
else { //Si no se busco ningun producto, muestra todos los productos 
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            <?php 
            /**
             * Ciclo foreach que accede a la tabla producto y muestra todos los registros 
             */
