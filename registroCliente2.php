  ...
  <div class="container">
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination justify-content-center">
        <li class="page-item "><a class="page-link" href="registroCliente1.php">Anterior</a></li>
        <li class="page-item"><a class="page-link" href="registroCliente3.php">Siguiente</a></li>
      </ul>
    </nav>
  </div>
